...
- [gray-matter](https://www.npmjs.com/package/gray-matter){:class="ext other"} - used for parsing the YAML into some usable information
- [showdown](https://www.npmjs.com/package/showdown){:class="ext other"} - actually turning the markdown into an html site.
...
(Follow me on [Twitter](https://twitter.com/12bz_trenchcoat){:class="ext twitter"} and look at more crimes against humanity on my [GitHub](https://github.com/andythepie){:class="ext github"}.)
